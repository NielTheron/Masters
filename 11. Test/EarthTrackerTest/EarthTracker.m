...
% Fixed to handle feature array correctly
%==========================================================================

% Determine number of features (works for both row and column inputs)
if size(feature, 1) == 2
    % Features are in columns (2×N)
    N = size(feature, 2);
    feature = feature'; % Convert to N×2
else
    % Features are in rows (N×2)
    N = size(feature, 1);
end
