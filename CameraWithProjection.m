...
quiver3(X,Y,0.01*z_ET(3,:,66), z_ET(1,:,66), z_ET(2,:,66), -0.01*z_ET(3,:,66),'off','LineWidth',2);
...
zLevel = 0; % Where to place the image along the Z-axis
...
theta = deg2rad(180);  % Rotation angle in radians
...
thetaz = deg2rad(180);  % Rotation angle in radians
